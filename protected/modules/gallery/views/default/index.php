...
if ($this->is(Access::ROLE_CONTROL)){
    ...
    if ($this->moduleAllowed('gallery')) $this->admin[] = array('label'=>'Работы', 'url'=>$this->createUrl('/gallery/photoAdmin/index'));
    if ($this->moduleAllowed('gallery')) $this->admin[] = array('label'=>'Добавить работу', 'url'=>$this->createUrl('/gallery/photoAdmin/create'));
