...
<?php $this->beginWidget('DPortlet', array('title' => 'Регистрация'));?>
    ...
    <div>
        ...
        <?php if (!$this->is(Access::ROLE_ADMIN)): ?>
            <div class="row">
                ...
                <?php echo $form->textField($model,'verifyCode', array('size'=>20)); ?>
                <?php echo $form->error($model,'verifyCode'); ?>
                <div>
                    <?php $this->widget('CCaptcha',array('buttonLabel'=>'<br />Показать другой код<br />', 'captchaAction'=>'/user/default/captcha')); ?>
                </div>
            </div>
        <?php endif; ?>
