...
<div class="form">
    ...
    <?php foreach($items as $item):
        ...
        <tr id="item_<?php echo $item->id; ?>">
            ...
            <td class="center"><?php if ($item->posts_count == 0) : ?><a class="ajax_del" data-del="item_<?php echo $item->id; ?>" title="Удалить группу &laquo;<?php echo CHtml::encode($item->title); ?>&raquo;" href="<?php echo $delurl; ?>"><img src="/core/images/admin/del.png" width="16" height="16" alt="Удалить" title="Удалить" /></a><?php endif; ?></td>
        </tr>
