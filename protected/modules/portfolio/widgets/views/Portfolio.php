...
<div class="portfolio ribbed">
    ...
    <div class="portfolioSlider">
        ...
        <?php foreach ($items as $item):  ?>
            <li><a rel="nofollow" href="<?php echo $item->url; ?>"><span class="thumb" style="background-image: url('<?php echo $item->getImageThumbUrl(190, 0); ?>')"><span><?php echo CHtml::encode($item->title); ?></span></span></a></li>
        <?php endforeach; ?>
            <li><a rel="nofollow" href="<?php echo Yii::app()->createUrl('/portfolio/default/index'); ?>"><span class="thumb" style="background-image: url('<?php echo Yii::app()->theme->baseUrl; ?>/images/portfolio.png')"></span></a></li>
        </ul>
    </div>
</div>
