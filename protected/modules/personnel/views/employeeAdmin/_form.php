...
<div class="form">
    ...
    <fieldset>
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'alias'); ?>&nbsp;<a href="javascript:transliterate('PersonnelEmployee_title', 'PersonnelEmployee_alias')">Транслит наименования</a><br />
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model,'category_id',array(''=>'') + PersonnelCategory::model()->getTabList()); ?><br />
