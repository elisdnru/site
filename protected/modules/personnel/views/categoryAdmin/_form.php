...
<div class="form">
    ...
    <fieldset>
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'alias'); ?>&nbsp;<a href="javascript:transliterate('PersonnelCategory_title', 'PersonnelCategory_alias')">Транслит наименования</a><br />
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList($model,'parent_id',array(0=>'') + ($model->parent_id ? array_diff_key(PersonnelCategory::model()->getTabList(), $model->getAssocList()) : PersonnelCategory::model()->getTabList())); ?><br />
