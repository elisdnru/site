...
<p style="font-family:arial; font-size:12px">На ваш комментарий к статье &laquo;<a href="<?php echo $url; ?>"><?php echo $comment->material->title; ?></a>&raquo; кто-то написал ответ:</p>
