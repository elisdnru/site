...
<p style="font-family:arial; font-size:12px;"><b>Получатель:</b> <a href="<?php echo $this->createUrl('/user/userAdmin/view', array('id'=>$order->user_id)); ?>"><?php echo $order->fio; ?></a><br />
...
<table style="border-collapse:collapse; font-family:arial; font-size:11px;" border="1" cellpadding="5">
    ...
    <tr>
        ...
        <td style="text-align:center"><?php echo number_format($product->count * $product->price, 0, '.', ' '); ?>р</td>
