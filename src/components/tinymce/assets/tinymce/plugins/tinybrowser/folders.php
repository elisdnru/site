...
$validtypes = ['image', 'media', 'file'];
$typenow = ((isset($_GET['type']) && in_array($_GET['type'], $validtypes)) ? $_GET['type'] : 'image');
$foldernow = str_replace(['../', '..\\', './', '.\\'], '', ($tinybrowser['allowfolders'] && isset($_REQUEST['folder']) ? urldecode($_REQUEST['folder']) : ''));
...
<div class="tabs">
    <ul>
        <li id="browse_tab">
            <span><a href="tinybrowser.php?type=<?php echo $typenow . $passfolder . $passfeid; ?>"><?php echo TB_BROWSE; ?></a></span>
        </li>
        <?php
        if ($tinybrowser['allowupload']) {
            ?>
            <li id="upload_tab">
            <span><a href="upload.php?type=<?php echo $typenow . $passfolder . $passfeid; ?>"><?php echo TB_UPLOAD; ?></a></span>
            </li>
            <?php
        }
        if ($tinybrowser['allowfolders']) {
            ?>
            <li id="edit_tab">
            <span><a href="edit.php?type=<?php echo $typenow . $passfolder . $passfeid; ?>"><?php echo TB_EDIT; ?></a></span>
            </li>
            <?php
        }
        ?>
        <li id="folders_tab" class="current">
            <span><a href="folders.php?type=<?php echo $typenow . $passfolder . $passfeid; ?>"><?php echo TB_FOLDERS; ?></a></span>
        </li>
    </ul>
</div>
</form>
    ...
    <div id="general_panel" class="panel currentmod">
        <fieldset>
            ...
            <div class="pushleft">
                ...
                $select = [];
                if ($tinybrowser['allowfolders']) {
                    $select[] = ['create', TB_CREATE];
                }
                if ($tinybrowser['allowdelete']) {
                    $select[] = ['delete', TB_DELETE];
                }
                if ($tinybrowser['allowedit']) {
                    $select[] = ['rename', TB_RENAME];
                }
