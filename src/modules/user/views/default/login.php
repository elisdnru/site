...
<?php $this->beginWidget(\app\modules\main\components\widgets\Portlet::class, ['title' => 'Войти, используя логин и пароль']); ?>
...
<?php $this->beginWidget(\app\modules\main\components\widgets\Portlet::class, ['title' => 'Регистрация и восстановление']); ?>
...
<?php $this->beginWidget(\app\modules\main\components\widgets\Portlet::class, ['title' => 'Вход через аккаунт в соцсети']); ?>
