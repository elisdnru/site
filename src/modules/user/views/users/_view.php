<div style="float:left; margin-bottom:10px">
    ...
    <a href="<?php use app\modules\main\components\helpers\SocNetworkHelper;
...
<div style="margin-left:70px;">
    ...
    <h4 class="nomargin">
        <?php if ($data->network) : ?>
            <a rel="nofollow" href="<?php echo $data->identity; ?>"><img style="vertical-align: middle" src="<?php echo SocNetworkHelper::getIcon($data->network); ?>" /></a>
        <?php endif; ?>
