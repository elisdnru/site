        ...
        init: function (ed, url) {
            ed.addCommand('mceYouTube', function () {
                ed.windowManager.open({
                    ...
                    height: 120 + parseInt(ed.getLang('youtube.delta_height', 0)),
                    inline: 1
                }, {plugin_url: url, some_custom_arg: 'custom arg'});
            });
            ed.addButton('youtube', {title: 'youtube.desc', cmd: 'mceYouTube', image: url + '/img/youtube.gif'});
            ...
            return {
                ...
                infourl: 'http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/youtube',
                version: "1.0"
            };
        }
    });
