...
while (($filename = readdir($dh)) !== false) {
    if ($filename != "." && $filename != ".." && $filename != "_thumbs" && !is_dir($tinybrowser['docroot'] . $editpath . $filename) && $filename != "Thumbs.db") {
        ...
        <fieldset>
            ...
            <div class="pushleft">
                ...
                if ($typenow == 'image' && $tinybrowser['allowedit']) {
                    $select[] = ["resize", TB_RESIZE];
                    $select[] = ["rotate", TB_ROTATE];
                }
                ...
                if ($tinybrowser['pagination'] > 0) {
                    ...
                    if ($i > 2) {
                        form_select($page, 'showpage', SHOW, $showpagenow, true);
                    }
                }
                ?></div>
...
?>
            <div class="tabularwrapper">
                <table class="browse">
                    <tr>
                        <th>
                            <a href="?type=<?php echo $typenow . $passfeid . $sortbyget['name']; ?>"<?php echo $thclass['name']; ?>><?php echo TB_FILENAME; ?></a>
                        </th>
                        <th>
                            <a href="?type=<?php echo $typenow . $passfeid . $sortbyget['size']; ?>"<?php echo $thclass['size']; ?>><?php echo TB_SIZE; ?></a>
                        </th>
                        <th>
                            <a href="?type=<?php echo $typenow . $passfeid . $sortbyget['type']; ?>"<?php echo $thclass['type']; ?>><?php echo TB_TYPE; ?>
                        </th>
