...
(function () {
    var DOM = tinymce.DOM, Element = tinymce.dom.Element, Event = tinymce.dom.Event, each = tinymce.each,
        is = tinymce.is;
...
//          f.top -= po.y;
            ...
            t._addAll(
                ...
                ['div', {
                    ...
                    'class': (ed.settings.inlinepopups_skin || 'clearlooks2') + (tinymce.isIE && window.getSelection ? ' ie9' : ''),
        ...
        _startDrag: function (id, se, ac) {
            var t = this, mu, mm, d = DOM.doc, eb, w = t.windows[id], we = w.element, sp = we.getXY(), p, sz, ph, cp,
                vp, sx, sy, sex, sey, dx, dy, dw, dh;
...
//          cp = DOM.getPos(t.editor.getContainer());
            ...
            function startMove()
            {
                ...
                DOM.add(eb.get(), 'div', {
                    ...
                    style: {left: sx, top: sy, width: sz.w, height: sz.h}
                });
