...
<div class="portfolio ribbed">
    ...
    <div class="portfolioSlider">
        ...
        <?php endforeach; ?>
            <li><a rel="nofollow" href="<?php echo Yii::app()->createUrl('/portfolio/default/index'); ?>"><span class="thumb" style="background-image: url('<?php echo Yii::app()->baseUrl; ?>/images/portfolio.png')"></span></a></li>
        </ul>
    </div>
</div>
