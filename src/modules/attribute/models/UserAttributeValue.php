...
class UserAttributeValue extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['owner_id, attribute_id', 'required'],
            ['owner_id, attribute_id', 'numerical', 'integerOnly' => true],
            ['value', 'safe'],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, owner_id, attribute_id, value', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        ...
        return [
            'attribute' => [self::BELONGS_TO, 'UserAttribute', 'attribute_id'],
        ];
    }
