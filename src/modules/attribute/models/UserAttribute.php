...
class UserAttribute extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['name, label, type, class, rule', 'required'],
            ['sort, required', 'numerical', 'integerOnly' => true],
            ['name, label, type, class', 'length', 'max' => 255],
            ['name', 'match', 'pattern' => '#^[a-zA-Z][a-zA-Z0-9_]+$#', 'message' => 'Только латинские символы, цифры и знак подчёркивания'],
            ['id, sort, name, label, type, class, rule', 'safe', 'on' => 'search'],
        ];
    }
    ...
    public function relations()
    {
        ...
        return [
            'values' => [self::HAS_MANY, 'UserAttributeValue', 'attribute_id'],
        ];
    }
