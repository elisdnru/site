...
<?php if($this->beginCache(__FILE__.__LINE__.'_post_'.$model->id, array('dependency'=>new Tags('gallery')))) { ?>
    ...
    <div class="gallery-display">
		...
		<div class="prev-next">
			<p>
				<?php if ($prev): ?><a class="link prev" rel="nofollow" href="<?php echo $prev->url; ?>#gallery-top">Предыдущее &raquo;</a><?php endif; ?><!--
				--><?php if ($next): ?><a class="link next" rel="nofollow" href="<?php echo $next->url; ?>#gallery-top">&laquo; Следующее</a><?php endif; ?>
			</p>
		</div>
