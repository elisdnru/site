...
if ($this->is(Access::ROLE_CONTROL)){
    ...
    if ($this->moduleAllowed('gallery')) $this->admin[] = array('label'=>'Редактировать работы', 'url'=>$this->createUrl('/gallery/photoAdmin/index', array('category'=>$category->id)));
    if ($this->moduleAllowed('gallery')) $this->admin[] = array('label'=>'Добавить работу', 'url'=>$this->createUrl('/gallery/photoAdmin/update', array('category'=>$category->id)));
    if ($this->moduleAllowed('gallery')) $this->admin[] = array('label'=>'Категории', 'url'=>$this->createUrl('/gallery/categoryAdmin/index'));
    if ($this->moduleAllowed('gallery')) $this->admin[] = array('label'=>'Редактировать категорию', 'url'=>$this->createUrl('/gallery/categoryAdmin/update', array('id'=>$category->id)));
...
<div class="subpages">
    <ul>
        <li class="return"><a rel="nofollow" href="<?php echo $category->parent ? $category->parent->url : $this->createUrl('/gallery/default/index'); ?>">&larr; Выше</a></li>
