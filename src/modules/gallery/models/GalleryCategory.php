...
class GalleryCategory extends TreeCategory
{
    ...
    public function relations()
    {
        ...
        return array_merge(parent::relations(), [
            'parent' => [self::BELONGS_TO, 'GalleryCategory', 'parent_id'],
            'photos_count' => [self::STAT, 'GalleryPhoto', 'category_id'],
            'photos' => [self::HAS_MANY, 'GalleryPhoto', 'category_id'],
            'child_items' => [self::HAS_MANY, 'GalleryCategory', 'parent_id',
                'order' => 'child_items.sort ASC'
            ],
            'items_count' => [self::STAT, 'GalleryPhoto', 'category_id',
                'condition' => 'public = 1',
            ],
        ]);
    }
