...
<header class="hidden-xs">
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
        <div class="container">
            ...
            <a href="#price" class="btn btn-danger navbar-btn pull-right">Принять участие</a>
        </div>
    </nav>
</header>
...
<section class="intro">
    <div class="container">
        <h1>Онлайн-интенсив <small style="color: #fff"> по практическому изучению<br />объектно-ориентированного
...
<section id="format">
    <div class="container">
        ...
        <div class="format-block">
            <ul>
                <li>Вы получите доступ к <b>личному кабинету ученика</b> с трансляциями и записями всех уроков.</li>
                <li>Уроки проходят в виде вебинаров-скринкастов с демонстрацией экрана и общением в чате.</li>
                <li>Доступ к кабинету останется у Вас навсегда, поэтому можете пересматривать когда угодно.</li>
                <li>Вы сможете заддать любые вопросы по материалу интенсива, если что-то было не очень понятно.</li>
...
<section id="program">
    <div class="container">
        ...
        <ul class="bul-list">
            ...
            <li>Научимся моделировать предметную область и разбивать сложную логику на объекты и модули.</li>
            <li>Научимся использовать &laquo;чистое&raquo; ООП и узнаем, чем оно полезно.</li>
            <li>Разберёмся, что же такое &laquo;Модель&raquo; и почему неправильно понимают аббревиатуры вроде MVC.</li>
            ...
            <li>Используя все эти принципы напишем полноценное приложение на фреймворке.</li>
        </ul>
    </div>
</section>
            ...
            <div class="col-sm-6">
                <div class="block">
                    ...
                    <ul>
                        ...
                        <li>Как функциональный подход применим к коду объектов</li>
            ...
            <div class="col-sm-6">
                <div class="block">
                    ...
                    <ul>
                        ...
                        <li>Композиция и агрегация вместо наследования</li>
            ...
            <div class="col-sm-6">
                <div class="block">
                    ...
                    <ul>
                        ...
                        <li>Зачем нам SOLID и что полезного в GRASP</li>
        ...
        <div class="row">
            <div class="col-sm-8 col-md-offset-2">
                <div class="price-item">
                    ...
                    <div class="block">
                        <p>
                            Если возникнут проблемы с оплатой, хотите оплатить от юрлица или
                            есть другой вопрос, то напишите
                            <a target="_blank" style="text-decoration: underline" href="/contacts">в обратную связь</a>
                        </p>
                    </div>
                    <div class="price-text"><span>6</span> дней по <span>5</span> часов прямого эфира</div>
                    <div class="price-button old">
                        <a href="https://products.elisdn.ru/order/oop-week-3/" target="_blank">Приобрести записи третьего потока</a>
                    </div>
                    <div class="price-button">
                        <a href="/blog/171/oop-week-4" target="_blank">Сходить на новый четвёртый поток</a>
                    </div>
                </div>
            </div>
        </div>
