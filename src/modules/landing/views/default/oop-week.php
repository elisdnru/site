        ...
        <div class="row">
            <div class="col-sm-8 col-md-offset-2">
                <div class="price-item">
                    ...
                    <div class="block">
                        <p>Если возникнут проблемы с оплатой (например, с Webmoney), не найдёте подходящего способа или
                            есть другой вопрос, то напишите <a target="_blank" style="text-decoration: underline"
                                                               href="/contacts">в обратную связь</a>.</p>
                    </div>
                    <div class="price-text"><span>6</span> дней по <span>5</span> часов за <span>5950</span> руб</div>
                    <div class="price-button"><a href="//products.elisdn.ru/order/oop-week-3-a/" target="_blank">Приобрести
                            записи</a></div>
                </div>
            </div>
        </div>
