        ...
        <div class="row">
            <div class="col-sm-8 col-md-offset-2">
                <div class="price-item">
                    ...
                    <div class="price-button"><a href="/order/laravel-board/" target="_blank">Приобрести все записи</a></div>
                    <p>или внести предоплату</p>
                    <div class="price-text">первые <span>4</span> темы за <span>4400</span> руб:</div>
                    <div class="price-button"><a href="/order/laravel-board-part-1/" target="_blank">Приобрести половину</a></div>
