        ...
        <div class="row">
            <div class="col-sm-8 col-md-offset-2">
                <div class="price-item">
                    ...
                    <div class="price-button"><a href="/order/project-manager-part-1/" target="_blank">Приобрести первую треть</a></div>

                    <p>или приобрести целиком:</p>
                    <div class="price-text"><span>1</span> вводный + <span>14</span> платных уроков</div>
                    <div class="price-button"><a href="/order/project-manager/" target="_blank">Приобрести все записи</a></div>
