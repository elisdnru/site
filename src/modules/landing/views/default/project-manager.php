...
<section class="intro">
    <div class="container">
        <h1>Пятнадцать дней прокачки<small style="color: #fff">Практический мастер класс<br />по разработке проекта на фреймворке под ключ</small>&laquo;Разработка менеджера-проектов&raquo;</h1>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div style="text-align: center">
            ...
            <p>
                ...
                Автор <a target="_blank" href="https://elisdn.ru">блога</a>, ведущий <a target="_blank" href="/blog/tag/%D0%92%D0%B5%D0%B1%D0%B8%D0%BD%D0%B0%D1%80">вебинаров</a> по веб-программированию,<br />автор интенсивов &laquo;<a target="_blank" href="/oop-week">Неделя ООП</a>&raquo; и &laquo;<a target="_blank" href="/yii2-shop">Магазин на Yii2</a>&raquo;.
            </p>
        </div>
    </div>
</section>
...
<section id="format">
    <div class="container">
        ...
        <div class="format-block">
            <ul>
                <li>Вы получите <b>доступ к личному кабинету ученика</b> со всеми последующими инструкциями и необходимой информацией о каждом уроке.</li>
                <li>Уроки проводились в <b>онлайн-формате</b> в виде вебинаров-скринкастов с демонстрацией экрана и общением в чате.</li>
                <li><b>Записи, тайм-коды и исходные коды</b> проекта выложены в личный кабинет. Доступ к ним останется у Вас навсегда, поэтому можете пересматривать когда угодно.</li>
                <li>Уроки проводились <b>1 раз в неделю по субботам в 19:00 по московскому времени</b>.</li>
                <li>Разбивка на уроки производится по времени (3-4 часа на урок), а не по темам.</li>
                <li>Первый вводный урок проведён бесплатно, поэтому в первой части оплачиваются 4 урока.</li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-sm-8 col-md-offset-2">
                <div class="price-item">
                    ...
                    <div class="price-button"><a href="//products.elisdn.ru/order/product-manager-part-1/" target="_blank">Приобрести первую треть</a></div>

                    <p>или приобрести целиком:</p>
                    <div class="price-text"><span>1</span> вводный + <span>14</span> платных уроков</div>
                    <div class="price-button"><a href="//products.elisdn.ru/order/product-manager/" target="_blank">Приобрести все записи</a></div>

                    <p style="text-align: center; font-size: 14px; margin-bottom: 30px"><a href="https://elisdn.ru/blog/130/enterprise-frameworks" target="_blank" style="text-decoration: underline">Посмотреть запись первого урока</a></p>
