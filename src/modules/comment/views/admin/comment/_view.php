...
<article class="comment<?= !$comment->moder ? ' newcomment' : ''; ?><?= !$comment->public ? ' nopublcomment' : ''; ?>" id="comment_<?= $comment->id; ?>">
    ...
    <header>
        ...
        <span class="link">
            <a class="ajax-post" title="Прочитать/Вернуть комментарий" href="<?= $moderurl; ?>"><img src="/images/admin/yes.png" width="16" height="16" alt="<?= $comment->public ? 'Прочесть' : 'Новый'; ?>" title="<?= $comment->public ? 'Прочесть' : 'Новый'; ?>"></a>
