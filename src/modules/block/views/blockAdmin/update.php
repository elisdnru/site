...
<p class="note">Код для вставки этого блока на страницу:
    <b><?php echo Yii::app()->controller->DInlineWidgetsBehavior->startBlock; ?>
        block|id=<?php echo CHtml::encode($model->alias); ?><?php echo Yii::app()->controller->DInlineWidgetsBehavior->endBlock; ?></b>
</p>
