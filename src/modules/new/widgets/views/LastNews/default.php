<?php foreach ($news as $data) : ?>
    <article class="entry list">
        <header>
            ...
            <div class="info">
                <p class="date"><span><time datetime="<?php echo date('Y-m-d', strtotime($data->date)); ?>" pubdate="pubdate"><?php echo DDateHelper::normdate($data->date); ?></time></span>
                </p>
                <?php if ($data->page) : ?>
                    <p class="category">
            ...
            <?php if ($data->image) : ?>
                ...
                ?>
                <p class="thumb">
                    <a rel="nofollow" href="<?php echo $data->url; ?>"><?php echo CHtml::image($data->getImageThumbUrl(), $data->image_alt, $properties); ?></a>
                </p>
            <?php endif; ?>
