 ...
 * @method mixed getAssocList()
 * @method mixed getAliasList()
 * @method mixed getMenuList($sub=0)
 */
class NewsGroup extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
            'news' => array(self::HAS_MANY, 'News', 'group_id',
                'condition'=>'news.public=1',
                'order'=>'news.date DESC, news.id DESC'
            ),
            'news_count' => array(self::STAT, 'News', 'group_id'),
		);
	}
