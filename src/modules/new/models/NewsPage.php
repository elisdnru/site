...
class NewsPage extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ['page_id, list_layout, show_layout, show_view', 'required'],
            ['page_id', 'numerical', 'integerOnly' => true],
            ['page_id', 'unique', 'className' => 'NewsPage'],
            ['list_layout, show_layout, show_view', 'length', 'max' => 255],
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            ['id, page_id, list_layout, show_layout, show_view', 'safe', 'on' => 'search'],
        ];
    }
    ...
    {
        $model = $this->findByAttributes(['page_id' => $page_id]);
